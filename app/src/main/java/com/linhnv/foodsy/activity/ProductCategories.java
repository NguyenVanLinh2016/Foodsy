...
public class ProductCategories extends AppCompatActivity {
    ...
    public void showChangeLangDialog() {
        ...
        final View dialogView = inflater.inflate(R.layout.dialog_product_catogories, null);
        ...
        dialogBuilder.setNegativeButton("Bỏ qua", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                //pass
            }
        });
