...
public class SearchActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String url_place = "https://foodsyapp.herokuapp.com/api/place";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* mPlaceList.add(new Places(1, "The Coffee House", "Di An, Binh Duong", "Coffee capuchino", "Cafe/Dessert", "10.5", 3));
        mPlaceList.add(new Places(2, "New Days", "Quan 3, Ho Chi Minh", "Matcha Trà Xanh", "Cafe/Dessert", "6.5", 4));
        mPlaceList.add(new Places(3, "Phở 24h ", "Quan 5, Ho Chi Minh", "Phở đặt biệt", "Quan an", "2.5", 3));
        mPlaceList.add(new Places(4, "Golden Vin Coffee", "Quan 1, Ho Chi Minh", "Trà sữa Cool", "Cafe/Dessert", "3.7", 5));
        mPlaceList.add(new Places(5, "Cơm tấm 68", "Quan 4, Ho Chi Minh", "Cơm tấm", "Nha hang", "8.0", 5));*/
    ...
    public class GetEatInfo extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String jsonStr = sh.makeServiceCall(url_place + "?latitude=" + latitude + "&longitude="
